  ...
  return (
    <button
      ...
      className={classnames(
        `transition-all duration-200 ${bgColor} text-white dark:bg-${darkBgColor} dark:hover:bg-${darkBgHoverColor} py-2 px-4 rounded font-medium text-center`,
        {
          'text-xs': size === 'sm',
          'text-md': size === 'md',
          'text-xl': size === 'lg',
          // 'bg-blue-600 hover:bg-blue-800': !isLoading,
