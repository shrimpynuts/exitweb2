...
export default function Searchbar({
  ...
  autoFocus?: boolean
  onEnterPress: (searchQuery: string) => void
}) {
  const [searchQuery, setSearchQuery] = useState('0xCF1f4b4f0FA1B41e74431E74551B4EF5424043DB')
  ...
  const onEnterPressHandler = async (checkFocused?: boolean) => {
  ...
  useKeyPress('Enter', () => onEnterPressHandler())
  ...
  return (
    <div className="relative mt-1 mx-auto rounded-md flex">
      <input
        ...
        type="text"
        autoCapitalize="none"
        className="text-gray-800 z-10 w-full shadow-sm focus:ring-blue-600 focus:border-blue-600 px-4 sm:text-sm border-gray-300 rounded-md
      ...
      <button
        className="absolute right-2 z-20 top-2 p-1 bg-blue-600 shadow-sm w-6 sm:text-sm 
        border-gray-400 rounded-md text-white dark:bg-gray-700 
        hover:bg-blue-500 dark:hover:bg-gray-800
        border dark:border-gray-700"
        onClick={() => onEnterPressHandler(false)}
      >
