CREATE TABLE "public"."messages" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), "text" text NOT NULL, "from" text NOT NULL, "community_id" uuid NOT NULL, PRIMARY KEY ("id") , FOREIGN KEY ("community_id") REFERENCES "public"."community"("id") ON UPDATE cascade ON DELETE cascade);
